...
declare namespace ProtocolProxyApi {
  ...
  export interface ProtocolDispatchers {
    ...
    CohtmlDebug: CohtmlDebugDispatcher;
  ...
  export interface ApplicationCacheApi {
     ...
     */
    invoke_getApplicationCacheForFrame(params: Protocol.ApplicationCache.GetApplicationCacheForFrameRequest): Promise<Protocol.ApplicationCache.GetApplicationCacheForFrameResponse>;
     ...
     */
    invoke_getManifestForFrame(params: Protocol.ApplicationCache.GetManifestForFrameRequest): Promise<Protocol.ApplicationCache.GetManifestForFrameResponse>;
  ...
  export interface PageApi {
     ...
     */
    invoke_setProduceCompilationCache(params: Protocol.Page.SetProduceCompilationCacheRequest): Promise<Protocol.ProtocolResponseWithError>;
  ...
  export interface CohtmlDebugApi {
    invoke_setDrawMetaDataEmit(params: Protocol.CohtmlDebug.SetDrawMetaDataEmitRequest): Promise<Protocol.ProtocolResponseWithError>;

    invoke_setContinuousRepaint(params: Protocol.CohtmlDebug.SetContinuousRepaintRequest): Promise<Protocol.ProtocolResponseWithError>;

    invoke_dumpDOM(): Promise<Protocol.ProtocolResponseWithError>;

    invoke_dumpStackingContext(): Promise<Protocol.ProtocolResponseWithError>;
